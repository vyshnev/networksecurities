...
class DataTransformation:
    ...
    def get_transformer_object(cls)->Pipeline:
        """
        It initilises a KNNIMputer object with the parameters specified in the training_pipeline.py file and returns 
        a pipline object with a KNNImputer object as the first step
